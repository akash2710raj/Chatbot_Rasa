...
function action_trigger() {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ message: "welcome", sender: user_id }),
...
function setBotResponse(response) {
    ...
    setTimeout(function() {
        ...
        if (response.length < 1) {
            ...
            var BotResponse = '<img class="botAvatar" src="./static/img/sara_avatar.png"/><p class="botMsg">' + response + '</p><div class="clearfix"></div>';
